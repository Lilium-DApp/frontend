            ...
            <div className='ml-48 mt-8'>
                <div className='w-1/2 min-h-1/2 p-4 pb-12 bg-darkgreen rounded-lg'>
                    <div className='flex justify-center py-2 gap-4'>
                        ...
                        <button className='bg-lightgreen w-64 py-3 rounded-lg mt-2 hover:bg-white hover:text-black duration-300 ease-in-out font-bold text-lg' onClick={() => setType('auction')}>Auction</button>
